...
class TelegramStartCommand extends Command
{
    ...
    public function handle()
    {
        ...
        $welcomeMessage .= "Docwise+ работает в <b>демо-режиме</b> и позволяет задавать вопросы по вашим документам.\n\n" .
        ...
        if ($documentsCount > 0) {
            ...
            $welcomeMessage .= "Загрузите документы через админ-панель и задавайте вопросы по ним через бота. Используйте /docs для списка доступных документов.";
        }
