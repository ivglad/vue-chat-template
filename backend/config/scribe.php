...
return [
    ...
    'description' => 'Docwise API предоставляет функционал для работы с чатом на основе документов и управления документами пользователей.',
    ...
    'auth' => [
        ...
        'placeholder' => '{ВАШ_ТОКЕН}',

        // Any extra authentication-related info for your users. Markdown and HTML are supported.
        'extra_info' => 'Вы можете получить токен авторизации через эндпоинт <code>POST /api/v1/auth/login</code>. Токен должен быть передан в заголовке Authorization с префиксом Bearer.',
    ],
    ...
    'strategies' => [
        ...
        'bodyParameters' => [
            ...
            // Добавляем кастомные примеры для конкретных эндпоинтов
            Strategies\StaticData::withSettings(data: [
