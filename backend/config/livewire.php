...
return [
    ...
    */
    ...
    'temporary_file_upload' => [
        ...
        'rules' => ['required', 'file', 'max:51200'],       // Example: ['file', 'mimes:png,jpg']  | Default: ['required', 'file', 'max:12288'] (12MB) - увеличиваем до 50MB
        ...
        'preview_mimes' => [   // Supported file types for temporary pre-signed file URLs...
            ...
            'pdf', 'doc', 'docx', 'txt', // Добавляем поддержку документов
        ],
